package com.mehmetpeker.recipe.ui.theme

import androidx.compose.material3.ColorScheme
import androidx.compose.runtime.Composable
import androidx.compose.ui.graphics.Color

val md_theme_light_primary = Color(0xFF6742CE)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFE8DDFF)
val md_theme_light_onPrimaryContainer = Color(0xFF20005E)
val md_theme_light_secondary = Color(0xFF615B71)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFE7DEF8)
...
val md_theme_light_surfaceTint = Color(0xFF6742CE)
...
val md_theme_dark_primaryContainer = Color(0xFF4F23B5)
...
val md_theme_dark_inversePrimary = Color(0xFF6742CE)
...
val ColorScheme.primaryRoundedCornerButtonBackground
        : Color
    @Composable
    get() = md_theme_light_primary

val ColorScheme.secondaryRoundedCornerButtonBackground
        : Color
    @Composable
    get() = onPrimary
